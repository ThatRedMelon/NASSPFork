...
namespace mission {
	...
	void Mission::SetDefaultValues()
	{
		...
		strCMPSuitName = "CMP";
		strLMPSuitName = "LMP";
		AddCSMCueCard(0, "ASTP_CUECARD_DAP");
		AddCSMCueCard(0, "ASTP_DOCKED_CUECARD_DAP");
		AddCSMCueCard(1, "ASTP_SATURN_BOOST");
		AddCSMCueCard(2, "ASTP_SPS_RNDZ");
		AddCSMCueCard(2, "ASTP_SPS_RNDZ_CONT");
		AddCSMCueCard(2, "ASTP_T&D");
		AddCSMCueCard(2, "ASTP_UVA_PREP");
		AddCSMCueCard(2, "ASTP_UVA_150M");
		AddCSMCueCard(2, "ASTP_UVA_500M");
		AddCSMCueCard(2, "ASTP_UVA_1000M");
		AddCSMCueCard(2, "ASTP_UVA_150M_NO_EMP");
		AddCSMCueCard(2, "ASTP_UVA_500M_NO_EMP");
		AddCSMCueCard(2, "ASTP_UVA_1000M");
		AddCSMCueCard(2, "ASTP_SPS_ENTRY");
		AddCSMCueCard(2, "ASTP_SPS_ENTRY_CONT");
		AddCSMCueCard(2, "ASTP_ENTRY");
		AddCSMCueCard(3, "ASTP_AC_BOOST");
		AddCSMCueCard(3, "ASTP_DEORB_ATT");
		AddCSMCueCard(3, "ASTP_DEORB_ATT_CONT");
		AddCSMCueCard(4, "ASTP_AC_ABORTS");
		AddCSMCueCard(4, "ASTP_PWR_LOSS_DV");
		AddCSMCueCard(4, "ASTP_UVA_RANGE");
		AddCSMCueCard(5, "ASTP_EPS_ECS_ABORTS");
		AddCSMCueCard(5, "ASTP_SPS_BURN_RULES");
		AddCSMCueCard(6, "ASTP_LANDING");
		AddCSMCueCard(7, "ASTP_PWR_USERS");
		AddCSMCueCard(8, "ASTP_DP_BOOST");
		AddCSMCueCard(8, "ASTP_PWR_LOSS_DV_PNL_3");
		// Add more here
		AddCSMCueCard(11, "ASTP_PWR_LOSS_LAUNCH");
		AddCSMCueCard(11, "ASTP_DV_FAILURES");
		AddCSMCueCard(12, "ASTP_RCS_MON");
		AddCSMCueCard(12, "ASTP_RCS_TBS");
		AddCSMCueCard(13, "ASTP_ECS_MON");
		AddCSMCueCard(14, "ASTP_LAUNCH_ABORT_PAD");
		AddCSMCueCard(15, "ASTP_SM_EXP");
		AddCSMCueCard(16, "ASTP_EXT_PHOTO");
	}
